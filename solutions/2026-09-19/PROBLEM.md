# Problem: raise ValueError("Cannot convert {0!r} to Excel".format(value))
...
https://stackoverflow.com/questions/59700493/raise-valueerrorcannot-convert-0r-to-excel-formatvalue
